    ...
    <div class="slide__view">
        <div class="slide__view-wrap">
            ...
            <div class="next__control slide__view-control">
                ...
                <div class="next__control-wrap">
                    <i class="next__control-icon fa-solid fa-chevron-right"></i>
                </div>
            </div>
        </div>
        <div class="slide__view-position gap-8 ">
            <div class="slide__view-position-item"></div>
            <div class="slide__view-position-item slide__view-position-item-active" ></div>
            <div class="slide__view-position-item"></div>
        </div>
    </div>
</div>
